...
class _BackgroundState extends State<_Background> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _scaleAnimation = Tween<double>(
      begin: 0.0, // Start with scale 0 (invisible)
      end: 1.5, // End with a scale size of 1.5
...
class _ForegroundState extends State<_Foreground> {
  ...
  late final _imageScale = Tween<double>(begin: 1, end: 3)
