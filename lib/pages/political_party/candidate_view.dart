...
class candidatesview extends StatefulWidget {
  ...
  @override
  State<candidatesview> createState() => _PoliticalPartyListState();
}

class _PoliticalPartyListState extends State<candidatesview> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _loadUserId().then((_) {
      if (userId != null) {
        fetchcandidate1(userId!);
        futurecandidate = fetchcandidate1(userId!); // Call fetchcampaign only if userId is not null
      } else {
