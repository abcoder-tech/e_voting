...
class politicaldispute extends StatefulWidget {
  const politicaldispute({super.key});

  @override
  State<politicaldispute> createState() => _ScheduleListState();
}
...
class _ScheduleListState extends State<politicaldispute> {
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          onPressed: () {
            _showAdddisputeDialog(context); // Show the add dispute dialog
          },
          tooltip: 'Add Dispute',
