...
import 'package:e_voting/pages/NEBE/campaign_view.dart';
import 'package:e_voting/pages/NEBE/candidates_view.dart';
        ...
        children: [
          Container(
            ...
            child: FloatingActionButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) =>  UpdatePoliticalParty(email:widget.email, name:widget.name, ima:widget.img)));
              },
              tooltip: 'Update',
              ...
              onPressed: () async {
                ...
                QuickAlert.show(
                  ...
                  onConfirmBtnTap: () async {
                    ...
                    await _deleteParty(); // Replace with your actual delete function
