...
class viewdisputee extends StatefulWidget {
  const viewdisputee({super.key});

  @override
  State<viewdisputee> createState() => _ScheduleListState();
}
...
class _ScheduleListState extends State<viewdisputee> {
