    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          onPressed: () {
            Navigator.push(context, MaterialPageRoute(builder: (context) => addpoliticalparty()));
          },
          tooltip: 'Add Party',
...
margin: EdgeInsets.only(bottom: 20),
          ...
          child: GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => viewparty(email: party.email)));
            },
            child: Stack(
              children: [
                Container(
